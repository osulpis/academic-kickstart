...
education:
  courses:
  - course: Ph.D. in Aquatic Geochemistry
    institution: McGill University
    year: 2019
  - course: B.Sc. in Earth and Environmental Science
    institution: ENS Lyon / Université Claude Bernard
    year: 2014
...
- icon: envelope
  icon_pack: fas
  link: '#contact'  # For a direct email link, use "mailto:o.j.t.sulpis@uu.nl".
- icon: twitter
  icon_pack: fab
